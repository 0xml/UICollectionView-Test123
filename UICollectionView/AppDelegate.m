...
- (NSURL *)applicationDocumentsDirectory {
  ...
  // code uses a directory named "io.ropa.UICollectionView" in the application's
  // documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
  ...
  NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"UICollectionView"
                                            withExtension:@"momd"];
  _managedObjectModel =
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
  ...
  NSURL *storeURL = [[self applicationDocumentsDirectory]
      URLByAppendingPathComponent:@"UICollectionView.sqlite"];
  NSError *error = nil;
